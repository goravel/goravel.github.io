...
[For Detail](../orm/getting-started#events)
...
| Method        | Action                                                               |
| ------------- | -------------------------------------------------------------------- |
| db.Raw        | [Raw Expressions](../orm/getting-started#raw-expressions)         |
| LockForUpdate | [Pessimistic Locking](../orm/getting-started#pessimistic-locking) |
| SharedLock    | [Pessimistic Locking](../orm/getting-started#pessimistic-locking) |
