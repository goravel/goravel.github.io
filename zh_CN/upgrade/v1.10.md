...
| 方法         | 行 动                                                                                                |
| ---------- | -------------------------------------------------------------------------------------------------- |
| 路由         | [Retrieving An Route Value](../basic/requests#Retrieving-An-Input-Value)                           |
