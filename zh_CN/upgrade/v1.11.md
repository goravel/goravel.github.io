...
| 商店        | [Accessing Multiple Cache Stores](../advanced/cache#accessing-multiple-cache-stores) |
...
| 共享锁                    | [Pessimistic Locking](../orm/quickstart#pessimistic-locking) |
...
| LastModified | [Get the last modified time of file](../advanced/fs#file-metadata) |
| MimeType     | [Get the mime type of file](../advanced/fs#file-metadata)          |
| 大小           | [Get the size of file](../advanced/fs#file-metadata)               |
