...
| Метод      | Действие                                                                                           |
| ---------- | -------------------------------------------------------------------------------------------------- |
| Маршрут    | [Retrieving An Route Value](../basic/requests#Retrieving-An-Input-Value)                           |
...
1. `Model` supports specify table name, [For Detail](../orm/quickstart);
...
| Функции           | Действие                                                   |
| ----------------- | ---------------------------------------------------------- |
| Сперва            | [Query or return data through callback](#Query-one-line)   |
| Первый Новый      | [Retrieving Or New Models](#Retrieving-Or-Creating-Models) |
| Первый Удар       | [Not Found Error](#Not-Found-Error)                        |
| Обновить OrCreate | [Update or create](#Update-or-create)                      |
