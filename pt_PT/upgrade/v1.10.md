...
| Método     | Acão                                                                                               |
| ---------- | -------------------------------------------------------------------------------------------------- |
| Rota       | [Retrieving An Route Value](../basic/requests#Retrieving-An-Input-Value)                           |
...
| Funções          | Acão                                                       |
| ---------------- | ---------------------------------------------------------- |
| Primeiro ou      | [Query or return data through callback](#Query-one-line)   |
| PrimeiroNovo     | [Retrieving Or New Models](#Retrieving-Or-Creating-Models) |
| PrimeiroOrFalhou | [Not Found Error](#Not-Found-Error)                        |
| Criar            | [Update or create](#Update-or-create)                      |
